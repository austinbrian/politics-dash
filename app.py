...
## Dash app ##
'''VISION:
    Want a large sctatter plot of counties, where you can select the x and y axis
        - maybe a color of clinton win = blue, clinton_not = red
    On the right, two axes that change during a mouseover:
        - the first is the predict_proba for all of the models that were 
          calculated for that county -- bar chart, descending order, fixed y-axis
        - the second is
                ???
'''
app = dash.Dash()
